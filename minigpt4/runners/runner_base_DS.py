...
class RunnerBaseDS:
    ...
    def __init__(self, cfg, task, ds_engine, datasets, job_id):
        self.config = cfg
        self.job_id = job_id
        ...
        self.optimizer = self.ds_engine.optimizer
        self.lr_scheduler = self.ds_engine.lr_scheduler
    ...
    def eval_epoch(self, split_name, cur_epoch, skip_reload=False):
        ...
        model = self.unwrap_dist_model(self.ds_engine)
    ...
    def _save_checkpoint(self, cur_epoch, is_best=False):
        ...
        """
        model_no_ddp = self.unwrap_dist_model(self.ds_engine)
        param_grad_dic = {
    ...
    def _load_checkpoint(self, url_or_filename):
        ...
        message = self.unwrap_dist_model(self.ds_engine).load_state_dict(state_dict,strict=False)
